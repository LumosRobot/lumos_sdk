...
class wbc_test_data_t(object):
    ...
    __slots__ = ["contact_est", "Fr_des", "Fr", "body_rpy_cmd", "body_ori_cmd", "body_pos_cmd", "body_vel_cmd", "body_ang_vel_cmd", "body_pos", "body_vel", "body_rpy", "body_ori", "body_ang_vel", "foot_pos_cmd", "foot_vel_cmd", "foot_acc_cmd", "foot_acc_numeric", "foot_pos", "foot_vel", "foot_local_pos", "foot_local_vel", "jpos_cmd", "jvel_cmd", "jacc_cmd", "jpos", "jvel", "vision_loc"]

    __typenames__ = ["int32_t", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[4], [12], [12], [3], [4], [3], [3], [3], [3], [3], [3], [4], [3], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [3]]
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x6d7e73f5b542a6e1) & 0xffffffffffffffff
