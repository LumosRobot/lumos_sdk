...
class simulator_lcmt(object):
    ...
    __dimensions__ = [[3], [3], None, None, [4], [3, 3], [3], [3], [3], [3], [3], [40], [40], [40], [40], [12], [12]]
    ...
    def __init__(self):
        ...
        """ LCM Type: double[3] """
        self.q = [ 0.0 for dim0 in range(40) ]
        """ LCM Type: double[40] """
        self.qd = [ 0.0 for dim0 in range(40) ]
        """ LCM Type: double[40] """
        self.qdd = [ 0.0 for dim0 in range(40) ]
        """ LCM Type: double[40] """
        self.tau = [ 0.0 for dim0 in range(40) ]
        """ LCM Type: double[40] """
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>40d', *self.q[:40]))
        buf.write(struct.pack('>40d', *self.qd[:40]))
        buf.write(struct.pack('>40d', *self.qdd[:40]))
        buf.write(struct.pack('>40d', *self.tau[:40]))
    ...
    def _decode_one(buf):
        ...
        self.q = struct.unpack('>40d', buf.read(320))
        self.qd = struct.unpack('>40d', buf.read(320))
        self.qdd = struct.unpack('>40d', buf.read(320))
        self.tau = struct.unpack('>40d', buf.read(320))
