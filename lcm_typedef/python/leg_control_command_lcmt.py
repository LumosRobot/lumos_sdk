...
class leg_control_command_lcmt(object):
    ...
    __slots__ = ["tau_ff", "f_ff", "q_des", "qd_des", "pos_des", "vel_des", "kp_cartesian", "kd_cartesian", "kp_joint", "kd_joint", "kp_motor", "kd_motor", "cmd_tau_est"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12]]
    ...
    def __init__(self):
        ...
        """ LCM Type: float[12] """
        self.pos_des = [ 0.0 for dim0 in range(12) ]
        """ LCM Type: float[12] """
        self.vel_des = [ 0.0 for dim0 in range(12) ]
        """ LCM Type: float[12] """
        ...
        """ LCM Type: float[12] """
        self.kp_motor = [ 0.0 for dim0 in range(12) ]
        """ LCM Type: float[12] """
        self.kd_motor = [ 0.0 for dim0 in range(12) ]
        """ LCM Type: float[12] """
        self.cmd_tau_est = [ 0.0 for dim0 in range(12) ]
        """ LCM Type: float[12] """
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>12f', *self.pos_des[:12]))
        buf.write(struct.pack('>12f', *self.vel_des[:12]))
        ...
        buf.write(struct.pack('>12f', *self.kp_motor[:12]))
        buf.write(struct.pack('>12f', *self.kd_motor[:12]))
        buf.write(struct.pack('>12f', *self.cmd_tau_est[:12]))
    ...
    def _decode_one(buf):
        ...
        self.pos_des = struct.unpack('>12f', buf.read(48))
        self.vel_des = struct.unpack('>12f', buf.read(48))
        ...
        self.kp_motor = struct.unpack('>12f', buf.read(48))
        self.kd_motor = struct.unpack('>12f', buf.read(48))
        self.cmd_tau_est = struct.unpack('>12f', buf.read(48))
        return self

    @staticmethod
    def _get_hash_recursive(parents):
        if leg_control_command_lcmt in parents: return 0
        tmphash = (0x620ed00b20f0fdea) & 0xffffffffffffffff
