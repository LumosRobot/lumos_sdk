...
class spi_data_t(object):
    ...
    __dimensions__ = [[4], [4], [4], [4], [4], [4], [12], None, [4], [4], [4]]
    ...
    def __init__(self):
        ...
        """ LCM Type: float[4] """
        self.flags = [ 0 for dim0 in range(12) ]
        """ LCM Type: int32_t[12] """
    ...
    def _encode_one(self, buf):
        ...
        buf.write(struct.pack('>12i', *self.flags[:12]))
    ...
    def _decode_one(buf):
        ...
        self.flags = struct.unpack('>12i', buf.read(48))
    ...
    def _get_hash_recursive(parents):
        ...
        tmphash = (0x8bbfb68d86b7504c) & 0xffffffffffffffff
