...
class pdik_test_data_t(object):
    ...
    __typenames__ = ["int32_t", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "float"]

    __dimensions__ = [[4], [4], [3], [3], [3], [3], [3], [4], [3], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [12], [3], [12], [12], [12], [12], [10], [12], None, None, None, None, None]
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", pdik_test_data_t._get_packed_fingerprint())[0]
