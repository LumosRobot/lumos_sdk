...
class arm_sensor_struct(object):
    ...
    __typenames__ = ["int32_t", "float", "float", "float", "int32_t", "int32_t"]

    __dimensions__ = [[14], [14], [14], [14], [14], [14]]
    ...
    def __init__(self):
        ...
        """
        current run mode              (14 actuators)
        LCM Type: float[14]
        """

        self.curSpeedVec = [ 0.0 for dim0 in range(14) ]
        """
        current joint current         (14 actuators)
        LCM Type: float[14]
        """

        self.curJointPosVec = [ 0.0 for dim0 in range(14) ]
        """
        current joint speed           (14 actuators)
        LCM Type: float[14]
        """

        self.curErrCodeVec = [ 0 for dim0 in range(14) ]
        """
        current joint pos             (14 actuators)
        LCM Type: int32_t[14]
        """

        self.isUsed = [ 0 for dim0 in range(14) ]
        """
        current joint error code      (14 actuators)
        LCM Type: int32_t[14]
        """
    ...
    def get_hash(self):
        ...
        return struct.unpack(">Q", arm_sensor_struct._get_packed_fingerprint())[0]
